 ...
 * @param <T>
 */
public abstract class PageListActivity_back<T> extends Activity {
	private String url = "";
	...
	private void createListView(){
		...
		mPullRefreshListView.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
			...
			public void onLastItemVisible() {
				Toast.makeText(PageListActivity_back.this, "End of List!", Toast.LENGTH_SHORT).show();
			}
		});
	}
	...
	public void load(boolean update, boolean loadMore){
		...
		finalHttp.get(checkEnv(), new AjaxCallBack<String>(){
			...
			public void onFailure(Throwable t, int errorNo, String strMsg) {
				Toast.makeText(PageListActivity_back.this, strMsg, Toast.LENGTH_SHORT).show();
